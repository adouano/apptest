        ...
        <Header userprofile={profile} />
            <div className="container-xl p-5">
                    ...
                    {/* {adherent.map((person) => ( */}
                            <div className="" key={adherent.id}>
                                ...
                                <div className="bg-body-tertiary mb-2">
                                    <div className="row">
                                        <div className="col-md-3 col-lg-3 justify-content-center"> 
                                        ...
                                        <div className="col-md-9 col-lg-9"> 
                                            <table className="table info_adht">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Nombre de protegé(s) : </td>
                                                        <td> {adherent.nombredeprotege} </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div className="">
                            ...
                            <div className='d-flex gap-2 float-end'>
                                <Versements adherent={adherent} relatives={relatives} depots={depots} config={config} restApayer={restApayer} />
                                <AjoutRelative adherent={adherent} />
                                {/* <Link to={`/${adherent.id}/ajout_relative`}>
                ...
                <div className="row py-5 bg-body-tertiary">
                    ...
                    <div className="row g-3">
                        <small className="text-body-secondary">
                            Veuillez utiliser le boutton "Ajouter Protégé" pour commencer à ajouter le/les protégé(s)...
                        </small>
                    </div>
                )}
            </div>
